...
Functions:
    ...
    * débuter_partie - Créer une nouvelle partie et retourne l'état
        de cette dernière.
...
def lister_parties(idul, secret):
    ...
    Raises:
        ...
        ConnectionError: Erreur levée lorsque le serveur retourne
        un code autre que 200, 401 ou 406
...
def débuter_partie(idul, secret):
    ...
    Raises:
        PermissionError: Erreur levée lorsque le serveur retourne un code 401.
        RuntimeError: Erreur levée lorsque le serveur retourne un code 406.
        ConnectionError: Erreur levée lorsque le serveur retourne un code
        autre que 200, 401 ou 406
    ...
    if r.status_code == 200:
        data: dict = r.json()
        id_partie, plateau, joueurs = data.get('id'), data.get('plateau'), \
            data.get('joueurs')
...
def jouer_coup(id_partie, origine, destination, idul, secret):
    ...
    Args:
        ...
        origine (int ou list): l'origine est soit un entier représentant
                               le numéro de la pile du joueur ou une liste
                               de 2 entier [x, y]
    ...
    Raises:
        StopIteration: Erreur levée lorsqu'il y a un gagnant dans
